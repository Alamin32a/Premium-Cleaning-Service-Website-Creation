import {
    ...
    B as Se,
    v as ae
} from "./index-Xq1yHI2j.js";
import {
    L as R,
    I as U,
    T as Ne
} from "./label-D9xB3NnT.js";
var y;
(function(r) {
    r.assertEqual = a => {};
...
const u = y.arrayToEnum(["string", "nan", "number", "integer", "float", "boolean", "date", "bigint", "symbol", "function", "undefined", "null", "array", "object", "unknown", "promise", "void", "never", "map", "set"]),
    ...
    d = y.arrayToEnum(["invalid_type", "invalid_literal", "custom", "invalid_union", "invalid_union_discriminator", "invalid_enum_value", "unrecognized_keys", "invalid_arguments", "invalid_return_type", "invalid_date", "invalid_string", "too_small", "too_big", "invalid_intersection_types", "not_multiple_of", "not_finite"]);
        ...
        const t = e || function(n) {
            ...
            a = n => {
                for (const i of n.issues)
                    ...
                    for (; h < i.path.length;) {
                        const f = i.path[h];
                        h === i.path.length - 1 ? (o[f] = o[f] || {
                            _errors: []
                        }, o[f]._errors.push(t(i))) : o[f] = o[f] || {
                            _errors: []
                        }, o = o[f], h++
                    }
                }
...
function c(r, e) {
    const t = je(),
        s = Ae({
            ...
            data: r.data,
            path: r.path,
            errorMaps: [r.common.contextualErrorMap, r.schemaErrorMap, t, t === G ? void 0 : G].filter(a => !!a)
        });
...
const m = Object.freeze({
    ...
    ie = r => r.status === "aborted",
    oe = r => r.status === "dirty",
    $ = r => r.status === "valid",
    q = r => typeof Promise < "u" && r instanceof Promise;
var l;
(function(r) {
...
class _ {
    ...
    _parseSync(e) {
        ...
        if (q(t)) throw new Error("Synchronous parse encountered promise.");
        return t
    }
    _parseAsync(e) {
        const t = this._parse(e);
    ...
    async safeParseAsync(e, t) {
        const s = {
            ...
            n = await (q(a) ? a : Promise.resolve(a));
        return de(s, n)
    }
    refine(e, t) {
...
const Ze = /^c[^\s-]{8,}$/i,
    Re = /^[0-9a-z]+$/,
    Ee = /^[0-9A-HJKMNP-TV-Z]{26}$/i,
    Ie = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
    $e = /^[a-z0-9_-]{21}$/i,
    Ve = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
    Le = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
    Pe = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
    Me = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let Q;
const ze = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/,
    De = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/,
    Be = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/,
    Fe = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/,
...
function He(r, e) {
    return !!((e === "v4" || !e) && ze.test(r) || (e === "v6" || !e) && Be.test(r))
}
...
function Ge(r, e) {
    return !!((e === "v4" || !e) && De.test(r) || (e === "v6" || !e) && Fe.test(r))
}
class N extends _ {
    _parse(e) {
        ...
        for (const n of this._def.checks)
            if (n.kind === "min") e.data.length < n.value && (a = this._getOrReturnCtx(e, a), c(a, {
                code: d.too_small,
                minimum: n.value,
                type: "string",
                inclusive: !0,
        ...
        } else if (n.kind === "email") Pe.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "email",
            code: d.invalid_string,
            message: n.message
        }), s.dirty());
        else if (n.kind === "emoji") Q || (Q = new RegExp(Me, "u")), Q.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "emoji",
            code: d.invalid_string,
            message: n.message
        }), s.dirty());
        else if (n.kind === "uuid") Ie.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "uuid",
            code: d.invalid_string,
            message: n.message
        }), s.dirty());
        else if (n.kind === "nanoid") $e.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "nanoid",
            code: d.invalid_string,
            message: n.message
        }), s.dirty());
        else if (n.kind === "cuid") Ze.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "cuid",
            code: d.invalid_string,
            message: n.message
        }), s.dirty());
        else if (n.kind === "cuid2") Re.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "cuid2",
            code: d.invalid_string,
            message: n.message
        }), s.dirty());
        else if (n.kind === "ulid") Ee.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "ulid",
            code: d.invalid_string,
            message: n.message
        }), s.dirty());
            ...
            message: n.message
        }), s.dirty()) : n.kind === "datetime" ? Ye(n).test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            code: d.invalid_string,
            validation: "datetime",
            message: n.message
        }), s.dirty()) : n.kind === "date" ? We.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            code: d.invalid_string,
            validation: "date",
            message: n.message
        }), s.dirty()) : n.kind === "time" ? Je(n).test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            code: d.invalid_string,
            validation: "time",
            message: n.message
        }), s.dirty()) : n.kind === "duration" ? Le.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "duration",
            code: d.invalid_string,
            message: n.message
            ...
            code: d.invalid_string,
            message: n.message
        }), s.dirty()) : n.kind === "jwt" ? Qe(e.data, n.alg) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "jwt",
            code: d.invalid_string,
            message: n.message
        }), s.dirty()) : n.kind === "cidr" ? Ge(e.data, n.version) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "cidr",
            code: d.invalid_string,
            message: n.message
        }), s.dirty()) : n.kind === "base64" ? Ue.test(e.data) || (a = this._getOrReturnCtx(e, a), c(a, {
            validation: "base64",
            code: d.invalid_string,
            message: n.message
...
class D extends _ {
    ...
    _parse(e) {
        ...
        let s;
        const a = new b;
        for (const n of this._def.checks) n.kind === "int" ? y.isInteger(e.data) || (s = this._getOrReturnCtx(e, s), c(s, {
            code: d.invalid_type,
            expected: "integer",
            received: "float",
            message: n.message
            ...
            exact: !1,
            message: n.message
        }), a.dirty()) : n.kind === "multipleOf" ? Xe(e.data, n.value) !== 0 && (s = this._getOrReturnCtx(e, s), c(s, {
...
class B extends _ {
    ...
    _parse(e) {
        ...
        let s;
        const a = new b;
        for (const n of this._def.checks) n.kind === "min" ? (n.inclusive ? e.data < n.value : e.data <= n.value) && (s = this._getOrReturnCtx(e, s), c(s, {
            code: d.too_small,
            type: "bigint",
            minimum: n.value,
            inclusive: n.inclusive,
...
class C extends _ {
    _parse(e) {
        ...
        if (a.minLength !== null && t.data.length < a.minLength.value && (c(t, {
            ...
            }), s.dirty()), t.common.async) return Promise.all([...t.data].map((i, o) => a.type._parseAsync(new j(t, i, t.path, o)))).then(i => b.mergeArray(s, i));
        const n = [...t.data].map((i, o) => a.type._parseSync(new j(t, i, t.path, o)));
...
function I(r) {
    ...
    } else return r instanceof C ? new C({ ...r._def,
        type: I(r.element)
    }) : r instanceof O ? O.create(I(r.unwrap())) : r instanceof P ? P.create(I(r.unwrap())) : r instanceof Z ? Z.create(r.items.map(e => I(e))) : r
}
class k extends _ {
    constructor() {
    ...
    _parse(e) {
        ...
        for (const f of i) {
            ...
            h.push({
                ...
                value: v._parse(new j(a, M, a.path, f)),
        ...
        if (this._def.catchall instanceof A) {
            ...
            else if (f === "strict") o.length > 0 && (c(a, {
            ...
            for (const v of o) {
                ...
                h.push({
                    ...
                    value: f._parse(new j(a, M, a.path, v)),
        ...
        return a.common.async ? Promise.resolve().then(async () => {
            ...
            return f
        }).then(f => b.mergeObjectSync(s, f)) : b.mergeObjectSync(s, h)
    }
    get shape() {
        return this._def.shape()
    }
    strict(e) {
        return l.errToObj, new k({ ...this._def,
            unknownKeys: "strict",
            ...e !== void 0 ? {
                errorMap: (t, s) => {
    ...
    required(e) {
        ...
        for (const s of y.objectKeys(this.shape))
            if (e && !e[s]) t[s] = this.shape[s];
                ...
                let n = this.shape[s];
                for (; n instanceof O;) n = n._def.innerType;
                t[s] = n
            }
        return new k({ ...this._def,
            shape: () => t
    ...
    keyof() {
        return be(y.objectKeys(this.shape))
    }
}
k.create = (r, e) => new k({
    shape: () => r,
...
class Y extends _ {
    _parse(e) {
        const {
            ...
            if (ie(n) || ie(i)) return m;
            const o = X(n.value, i.value);
            return o.valid ? ((oe(n) || oe(i)) && t.dirty(), {
                status: t.value,
                value: o.data
            }) : (c(s, {
...
class Z extends _ {
    _parse(e) {
        ...
        const n = [...s.data].map((i, o) => {
            ...
            return h ? h._parse(new j(s, i, s.path, o)) : null
        }).filter(i => !!i);
    ...
    _parse(e) {
        ...
        const a = this._def.keyType,
            ...
            i = [...s.data.entries()].map(([o, h], f) => ({
                key: a._parse(new j(s, o, s.path, [f, "key"])),
                value: n._parse(new j(s, h, s.path, [f, "value"]))
            }));
        if (s.common.async) {
            const o = new Map;
...
class F extends _ {
    _parse(e) {
        ...
        const o = [...s.data.values()].map((h, f) => n._parse(new j(s, h, s.path, f)));
...
class V extends _ {
    ...
    exclude(e, t = this._def) {
        return V.create(this.options.filter(s => !e.includes(s)), { ...this._def,
            ...t
        })
    }
}
    ...
    _parse(e) {
        ...
        if (a.type === "transform")
            if (s.common.async === !1) {
                ...
                path: s.path,
                parent: s
            }).then(i => $(i) ? Promise.resolve(a.transform(i.value, n)).then(o => ({
                status: t.value,
                value: o
            })) : m);
        y.assertNever(a)
...
class se extends _ {
    _parse(e) {
        const t = this._def.innerType._parse(e),
            s = a => ($(a) && (a.value = Object.freeze(a.value)), a);
...
P.create;
const st = et({
    name: E().trim().min(2, "Please enter your name").max(80),
    email: E().trim().email("Enter a valid email").max(160),
    phone: E().trim().min(7, "Enter a valid phone").max(30),
    service: E().min(1, "Choose a service"),
    postcode: E().trim().min(2, "Enter a postcode").max(12),
    message: E().trim().max(800).optional().or(tt(""))
});
...
function nt({
    ...
    async function a(n) {
        n.preventDefault();
        const i = new FormData(n.currentTarget),
            o = st.safeParse({
                name: i.get("name"),
                email: i.get("email"),
                phone: i.get("phone"),
        ...
        if (!o.success) {
            ae.error(o.error.issues[0] ? .message ? ? "Please check the form");
            return
        }
        s(!0), await new Promise(h => setTimeout(h, 800)), s(!1), n.target.reset(), ae.success("Thanks — we'll be in touch within 1 business hour.")
    }
    return x.jsxs("form", {
        onSubmit: a,
        className: "grid gap-4",
        children: [x.jsxs("div", {
            className: r ? "grid gap-4" : "grid gap-4 sm:grid-cols-2",
            children: [x.jsxs("div", {
                children: [x.jsx(R, {
                    htmlFor: "name",
                    children: "Full name"
            ...
            children: [x.jsx(R, {
                ...
                maxLength: 800,
                rows: 4,
                placeholder: "Site size, frequency, access notes…",
                className: "mt-1.5"
            })]
        }), x.jsx(Se, {
            type: "submit",
            disabled: t,
            className: "h-12 bg-accent text-accent-foreground hover:opacity-90",
            children: t ? "Sending…" : "Request my free quote"
        }), x.jsx("p", {
            className: "text-xs text-muted-foreground",
            children: "By submitting, you agree to be contacted about your enquiry. We never share your data."
        })]
    })
}
export {
